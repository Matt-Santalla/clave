          ...
          >
            ...
            <div
              ...
              className={cn(
                ...
                draggingLeft ? 'w-1 bg-accent-primary' : 'w-1.5 hover:w-1 hover:bg-accent-primary/50'
              )}
            />
          </motion.div>
        )}
          ...
          >
            ...
            <div
              ...
              className={cn(
                ...
                draggingRight ? 'w-1 bg-accent-primary' : 'w-1.5 hover:w-1 hover:bg-accent-primary/50'
              )}
            />
            <SidePanel />
          </motion.div>
